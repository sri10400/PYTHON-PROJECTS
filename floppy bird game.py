...
#high score
high_score = 0  # Top-level declaration
...
def show_game_over_screen(score):
    ...
    text3 = font.render(f'High Score: {high_score}', True, (0, 255, 0))
    text4 = font.render('Press Space to Play Again', True, (255, 255, 0))

    window.blit(text1, (window_width//2 - text1.get_width()//2, 120))
    window.blit(text2, (window_width//2 - text2.get_width()//2, 190))
    window.blit(text3, (window_width//2 - text3.get_width()//2, 250))
    window.blit(text4, (window_width//2 - text4.get_width()//2, 310))
    pygame.display.update()
